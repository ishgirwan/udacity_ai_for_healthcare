...
if __name__ == "__main__":
    ...
    os_command(f"sudo storescu localhost 4242 -v -aec HIPPOAI +r +sd /home/workspace/out/report.dcm")
    #os_command("sudo storescu 127.0.0.1 4242 -v -aec HIPPOAI +r +sd home/workspace/out/report.dcm")
